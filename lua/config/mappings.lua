...
do
  ...
  vim.keymap.set("i", "<C-j>", "<C-o>o", opts_1_auto)
end
do
  local opts_1_auto
  do
  ...
  vim.keymap.set("i", "<C-k>", "<C-o>O", opts_1_auto)
end
do
  local opts_1_auto
  do
...
vim.api.nvim_create_autocmd({"FileType"}, {pattern = {"git", "qf", "man", "help", "lspinfo", "fugitive", "gitcommit"}, callback = _76_, group = group})
local function _80_()
...
vim.api.nvim_create_autocmd({"FileType"}, {pattern = {"*"}, callback = _80_, group = group})
local function _85_()
...
vim.api.nvim_create_autocmd({"BufEnter"}, {pattern = {"*"}, callback = _85_, group = group})
return nil
