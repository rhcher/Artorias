...
local function _2_(args)
  ...
  if (client:supports_method(ms.textDocument_formatting) and client:supports_method(ms.textDocument_rangeFormatting)) then
    ...
    do
      local tbl_21_ = {}
      for k_4_auto, v_5_auto in pairs(({buffer = bufnr} or {})) do
    ...
    vim.keymap.set({"n", "v"}, "<leader>lf", _6_, opts_3_auto)
  else
  end
  if client:supports_method(ms.textDocument_prepareCallHierarchy) then
    do
      ...
      vim.keymap.set("n", "<leader>ii", vim.lsp.buf.incoming_calls, opts_3_auto)
    end
    local opts_3_auto
    do
      local tbl_21_ = {}
    ...
    vim.keymap.set("n", "<leader>io", vim.lsp.buf.outgoing_calls, opts_3_auto)
  else
  end
  if client:supports_method(ms.textDocument_documentSymbol) then
    ...
    vim.keymap.set("n", "<leader>lw", "<cmd>Lspsaga outline<CR>", opts_3_auto)
  else
  end
  if client:supports_method(ms.workspace_symbol) then
    ...
    vim.keymap.set("n", "<leader>lW", vim.lsp.buf.workspace_symbol, opts_3_auto)
  else
  end
  if client:supports_method(ms.textDocument_codeAction) then
    ...
    vim.keymap.set({"n", "v"}, "<leader>la", vim.lsp.buf.code_action, opts_3_auto)
  else
  end
  if client:supports_method(ms.textDocument_codeLens) then
    ...
    if client:supports_method(ms.workspace_executeCommand) then
      ...
      vim.keymap.set("n", "<leader>ll", vim.lsp.codelens.run, opts_3_auto)
    else
    end
  else
  end
  do
    ...
    vim.keymap.set("n", "gd", vim.lsp.buf.definition, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "gD", vim.lsp.buf.declaration, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "gi", vim.lsp.buf.implementation, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "gr", _45_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "K", _49_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<leader>k", "<cmd>Lspsaga hover_doc ++keep<CR>", opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<leader>lr", ":Lspsaga rename<CR>", opts_3_auto)
  end
...
local function _60_(_, bufnr)
  ...
  do
    ...
    vim.keymap.set("n", "<C-k>", _64_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<C-j>", _68_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<C-l>", _72_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<C-h>", _76_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>ii", _80_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>io", _84_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>vf", _88_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>vl", _92_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>vp", _96_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>mv", _100_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>mf", _104_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>mt", _108_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>ib", _112_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>id", _116_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>gw", _120_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>gr", _124_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>gm", _128_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>gn", _132_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>cf", _136_, opts_3_auto)
  end
  do
    local opts_3_auto
    do
    ...
    vim.keymap.set("n", "<space>ci", _140_, opts_3_auto)
  end
...
vim.lsp.config("emmylua_ls", {cmd = {"emmylua_ls"}, filetypes = {"lua"}, root_markers = {".luarc.json", ".emmyrc.json", ".luacheckrc", ".git"}, workspace_required = false})
...
return vim.lsp.enable({"clangd", "lua_ls", "basedpyright"})
