...
do
  ...
  do
    local tbl_21_ = {}
    for k_4_auto, v_5_auto in pairs(({noremap = true, silent = true} or {})) do
  ...
  vim.keymap.set("n", "<space>le", _4_, opts_3_auto)
end
do
  local opts_3_auto
  do
  ...
  vim.keymap.set("n", "<space>lQ", vim.diagnostic.setqflist, opts_3_auto)
end
do
  local opts_3_auto
  do
  ...
  vim.keymap.set("n", "<space>lq", vim.diagnostic.setloclist, opts_3_auto)
end
do
  local opts_3_auto
  do
