...
return pair.setup({cr = {conf = {nft = util["lisp-language"]}}, bs = {space = false, single_delete = false}, space = {enable = true}, tabout = {enable = true, map = "<tab>", hopout = true, do_nothing_if_fail = false}})
